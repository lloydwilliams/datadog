...
WL_HOME="/u01/fmw/Oracle/Middleware/Oracle_Home/wlserver"
export WL_HOME
...
SUN_JAVA_HOME="/u01/java/jdk1.8.0_311"
export SUN_JAVA_HOME

DEFAULT_SUN_JAVA_HOME="/u01/java/jdk1.8.0_311"
...
if [ "${VM_TYPE}" = "JRockit" ] ; then
	...
	if [ "${JAVA_VENDOR}" = "Sun" ] ; then
		...
		JAVA_VENDOR="Oracle"
		export JAVA_VENDOR
		JAVA_HOME="/u01/java/jdk1.8.0_311"
		export JAVA_HOME
		VM_TYPE="HotSpot"
		export VM_TYPE
	fi
...
LONG_DOMAIN_HOME="/u01/fmw/Oracle/Middleware/Oracle_Home/user_projects/domains/wl_server"
...
case ${JAVA_OPTIONS} in *-Dweblogic.management.server=*) export ADD_ADMIN_URL_TO_CLUSTER_PROP="false" ;; *) export ADD_ADMIN_URL_TO_CLUSTER_PROP="true" ;; esac
...
if [ "${ADMIN_URL}" = "" ] ; then
	...
	if [ "${ADD_ADMIN_URL_TO_CLUSTER_PROP}" = "false" ] ; then
		CLUSTER_PROPERTIES=""
		export CLUSTER_PROPERTIES
	else
...
PRE_CLASSPATH="/u01/fmw/Oracle/Middleware/Oracle_Home/wlserver/samples/server/examples/build/serverclasses${CLASSPATHSEP}/u01/fmw/Oracle/Middleware/Oracle_Home/wlserver/samples/server/examples/src"
