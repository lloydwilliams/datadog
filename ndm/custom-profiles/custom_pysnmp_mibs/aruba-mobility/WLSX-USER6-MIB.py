...
# ASN.1 source file:///Users/lloyd.williams/u01/snmp/mibdump/asn1/WLSX-USER6-MIB
...
ArubaPhyType, ArubaAuthenticationMethods, ArubaHTMode, ArubaEncryptionType, ArubaSubAuthenticationMethods, ArubaUserForwardMode = mibBuilder.importSymbols("ARUBA-TC", "ArubaPhyType", "ArubaAuthenticationMethods", "ArubaHTMode", "ArubaEncryptionType", "ArubaSubAuthenticationMethods", "ArubaUserForwardMode")
OctetString, Integer, ObjectIdentifier = mibBuilder.importSymbols("ASN1", "OctetString", "Integer", "ObjectIdentifier")
NamedValues, = mibBuilder.importSymbols("ASN1-ENUMERATION", "NamedValues")
ValueRangeConstraint, ConstraintsIntersection, SingleValueConstraint, ConstraintsUnion, ValueSizeConstraint = mibBuilder.importSymbols("ASN1-REFINEMENT", "ValueRangeConstraint", "ConstraintsIntersection", "SingleValueConstraint", "ConstraintsUnion", "ValueSizeConstraint")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ModuleIdentity, ObjectIdentity, Counter64, Unsigned32, IpAddress, Bits, Gauge32, NotificationType, snmpModules, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ModuleIdentity", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress", "Bits", "Gauge32", "NotificationType", "snmpModules", "Counter32", "MibIdentifier")
TimeInterval, TextualConvention, DisplayString, TruthValue, StorageType, TAddress, TestAndIncr, PhysAddress, TDomain, RowStatus, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "TextualConvention", "DisplayString", "TruthValue", "StorageType", "TAddress", "TestAndIncr", "PhysAddress", "TDomain", "RowStatus", "MacAddress")
...
mibBuilder.exportSymbols("WLSX-USER6-MIB", nUser6UPBWContractUsage=nUser6UPBWContractUsage, user6BWContractName=user6BWContractName, nUser6HTMode=nUser6HTMode, user6Name=user6Name, nUser6DNBWContractUsage=nUser6DNBWContractUsage, nUser6Role=nUser6Role, nUser6DefaultVlan=nUser6DefaultVlan, wlsxUser6AllInfoGroup=wlsxUser6AllInfoGroup, wlsxUser6SessionTimeTable=wlsxUser6SessionTimeTable, nUser6IsWired=nUser6IsWired, user6ConnectedSlot=user6ConnectedSlot, nUser6SubAuthenticationMethod=nUser6SubAuthenticationMethod, nUser6ApLocation=nUser6ApLocation, nUser6ApBSSID=nUser6ApBSSID, nUser6ConnectedPort=nUser6ConnectedPort, nUser6DeviceID=nUser6DeviceID, nUser6IsOnHomeAgent=nUser6IsOnHomeAgent, user6Location=user6Location, nUser6BWContractName=nUser6BWContractName, nUser6DNBWContractName=nUser6DNBWContractName, nUser6DNBWContractId=nUser6DNBWContractId, nUser6UPBWContractName=nUser6UPBWContractName, nUser6IsProxyArpEnabled=nUser6IsProxyArpEnabled, nUser6TxDataPkts64=nUser6TxDataPkts64, user6PhyAddress=user6PhyAddress, nUser6AuthServerName=nUser6AuthServerName, nUser6AuthenticationMethod=nUser6AuthenticationMethod, wlsxTotalNumOfUsers6=wlsxTotalNumOfUsers6, nUser6EncryptionMethod=nUser6EncryptionMethod, nUser6HomeAgentIpAddress=nUser6HomeAgentIpAddress, wlsxUser6MIB=wlsxUser6MIB, nUser6MobilityStatus=nUser6MobilityStatus, nUser6ConnectedSlot=nUser6ConnectedSlot, user6UpTime=user6UpTime, user6ConnectedPort=user6ConnectedPort, user6ConnectedVlan=user6ConnectedVlan, nUser6BWContractUsage=nUser6BWContractUsage, nUser6Name=nUser6Name, nUser6ConnectedModule=nUser6ConnectedModule, wlsxUser6SessionTimeCount=wlsxUser6SessionTimeCount, user6Role=user6Role, wlsxUser6SessionTimeEntry=wlsxUser6SessionTimeEntry, nUser6PhyType=nUser6PhyType, PYSNMP_MODULE_ID=wlsxUser6MIB, nVIAUser6DeviceID=nVIAUser6DeviceID, wlsxSwitchUser6Entry=wlsxSwitchUser6Entry, wlsxSwitchUser6Table=wlsxSwitchUser6Table, user6ConnectedModule=user6ConnectedModule, nUser6DeviceType=nUser6DeviceType, nUser6BWContractId=nUser6BWContractId, nUser6ExtVPNAddress=nUser6ExtVPNAddress, user6BWContractUsage=user6BWContractUsage, wlsxUser6Entry=wlsxUser6Entry, nUser6PhyAddress=nUser6PhyAddress, nUser6UPBWContractId=nUser6UPBWContractId, nUser6MobilityDomainName=nUser6MobilityDomainName, user6AuthenticationMethod=user6AuthenticationMethod, nUser6AssignedVlan=nUser6AssignedVlan, nUser6IpAddress=nUser6IpAddress, nUser6RxDataPkts64=nUser6RxDataPkts64, nUser6ForwardMode=nUser6ForwardMode, nUser6UpTime=nUser6UpTime, user6ServerName=user6ServerName, nUser6TxDataOctets64=nUser6TxDataOctets64, user6IpAddress=user6IpAddress, wlsxUser6InfoGroup=wlsxUser6InfoGroup, nUser6RxDataOctets64=nUser6RxDataOctets64, wlsxUser6Table=wlsxUser6Table, nUser6HomeVlan=nUser6HomeVlan, nUser6CurrentVlan=nUser6CurrentVlan, wlsxUser6SessionTimeLength=wlsxUser6SessionTimeLength)
