...
# ASN.1 source file:///Users/lloyd.williams/u01/snmp/mibdump/asn1/WLSX-MOBILITY-MIB
# Produced by pysmi-0.3.4 at Tue Jan 31 16:13:57 2023
...
ArubaFrameType, ArubaAuthenticationMethods, ArubaRogueApType, ArubaPhyType, ArubaEncryptionMethods, ArubaActiveState, ArubaEnableValue = mibBuilder.importSymbols("ARUBA-TC", "ArubaFrameType", "ArubaAuthenticationMethods", "ArubaRogueApType", "ArubaPhyType", "ArubaEncryptionMethods", "ArubaActiveState", "ArubaEnableValue")
OctetString, Integer, ObjectIdentifier = mibBuilder.importSymbols("ASN1", "OctetString", "Integer", "ObjectIdentifier")
NamedValues, = mibBuilder.importSymbols("ASN1-ENUMERATION", "NamedValues")
SingleValueConstraint, ValueRangeConstraint, ConstraintsUnion, ValueSizeConstraint, ConstraintsIntersection = mibBuilder.importSymbols("ASN1-REFINEMENT", "SingleValueConstraint", "ValueRangeConstraint", "ConstraintsUnion", "ValueSizeConstraint", "ConstraintsIntersection")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Unsigned32, ObjectIdentity, ModuleIdentity, iso, TimeTicks, snmpModules, Integer32, Counter32, Bits, NotificationType, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "iso", "TimeTicks", "snmpModules", "Integer32", "Counter32", "Bits", "NotificationType", "Gauge32", "Counter64")
TDomain, TAddress, RowStatus, MacAddress, TruthValue, TextualConvention, TimeInterval, StorageType, DisplayString, PhysAddress, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TDomain", "TAddress", "RowStatus", "MacAddress", "TruthValue", "TextualConvention", "TimeInterval", "StorageType", "DisplayString", "PhysAddress", "TestAndIncr")
...
mibBuilder.exportSymbols("WLSX-MOBILITY-MIB", wlsxMobilityMIB=wlsxMobilityMIB, wlsxMobilityDomainEntry=wlsxMobilityDomainEntry, mobilityHostHomeMask=mobilityHostHomeMask, mobilityProxyPktFwd=mobilityProxyPktFwd, mobilityFARRQReject=mobilityFARRQReject, mobilityFAMalform=mobilityFAMalform, mobilityHostIp=mobilityHostIp, mobilityProxyDhcpPktProc=mobilityProxyDhcpPktProc, mobilityHomeAgentVlan=mobilityHomeAgentVlan, wlsxMobilityConfigGroup=wlsxMobilityConfigGroup, mobilityHostMac=mobilityHostMac, mobilitySentRRVAck=mobilitySentRRVAck, mobilityHostStatus=mobilityHostStatus, mobilityProxyBadDHCPPkt=mobilityProxyBadDHCPPkt, mobilitySentRRVRQ=mobilitySentRRVRQ, wlsxMobilityHostTable=wlsxMobilityHostTable, mobilityProxyClientEssidChg=mobilityProxyClientEssidChg, mobilityHAMalform=mobilityHAMalform, mobilityDomainStatus=mobilityDomainStatus, wlsxMobilityHostEntry=wlsxMobilityHostEntry, mobilityProxyDHCPUnexpFrame=mobilityProxyDHCPUnexpFrame, mobilityHostServiceTime=mobilityHostServiceTime, wlsxMobilityProxyDHCPStatsGroup=wlsxMobilityProxyDHCPStatsGroup, mobilityProxyPktDrop=mobilityProxyPktDrop, mobilityRcvRRV=mobilityRcvRRV, mobilityHAFAauthFail=mobilityHAFAauthFail, mobilityHARRQNoResource=mobilityHARRQNoResource, mobilityProxyClientIPChg=mobilityProxyClientIPChg, mobilityProxyPktHandled=mobilityProxyPktHandled, mobilityRRVRQIgnore=mobilityRRVRQIgnore, mobilityHARRQDenied=mobilityHARRQDenied, PYSNMP_MODULE_ID=wlsxMobilityMIB, mobilityFABadID=mobilityFABadID, mobilityFASentRRQ=mobilityFASentRRQ, wlsxMobilityFAStatsGroup=wlsxMobilityFAStatsGroup, mobilityHomeAgentIp=mobilityHomeAgentIp, mobilityProxyDhcpBootpRx=mobilityProxyDhcpBootpRx, mobilityProxyDHCPNak=mobilityProxyDHCPNak, mobilityRRVAckIgnore=mobilityRRVAckIgnore, mobilityDomainIsExclusive=mobilityDomainIsExclusive, mobilityFARRQAccept=mobilityFARRQAccept, wlsxMobilityHomeAgentTable=wlsxMobilityHomeAgentTable, mobilityHATooManyBnd=mobilityHATooManyBnd, wlsxMobilityHomeAgentEntry=wlsxMobilityHomeAgentEntry, mobilityHARRQAdminDeny=mobilityHARRQAdminDeny, mobilityRcvRRVAck=mobilityRcvRRVAck, mobilityHAMNauthFail=mobilityHAMNauthFail, mobilityDomainName=mobilityDomainName, mobilityHostDhcpInfo=mobilityHostDhcpInfo, wlsxMobilityHAFARevocationStatsGroup=wlsxMobilityHAFARevocationStatsGroup, mobilityProxyNoMobility=mobilityProxyNoMobility, mobilityProxyNotDHCP=mobilityProxyNotDHCP, mobilityFAHAauthFAIL=mobilityFAHAauthFAIL, mobilityHABndExpire=mobilityHABndExpire, mobilityHARxRRQ=mobilityHARxRRQ, mobilityHostHomeVlan=mobilityHostHomeVlan, mobilityProxyDhcpPktFwd=mobilityProxyDhcpPktFwd, mobilityHomeAgentMask=mobilityHomeAgentMask, mobilityProxyDhcpPktDrop=mobilityProxyDhcpPktDrop, mobilityHARRQAccept=mobilityHARRQAccept, wlsxMobilityDomainTable=wlsxMobilityDomainTable, mobilityProxyDHCPUnexpRemote=mobilityProxyDHCPUnexpRemote, mobilityProxyBusy=mobilityProxyBusy, mobilityFARcvRRP=mobilityFARcvRRP, mobilityHomeAgentSubnet=mobilityHomeAgentSubnet, wlsxMobilityHAStatsGroup=wlsxMobilityHAStatsGroup, mobilityMNHAauthFAIL=mobilityMNHAauthFAIL, wlsxMobilityProxyStatsGroup=wlsxMobilityProxyStatsGroup, mobilityProxyPktRx=mobilityProxyPktRx, mobilityHABadID=mobilityHABadID, mobilityHostHomeNetwork=mobilityHostHomeNetwork, mobilityProxyDHCPNoHomeVlan=mobilityProxyDHCPNoHomeVlan, mobilityHARRQIgnore=mobilityHARRQIgnore, mobilityHASentRRP=mobilityHASentRRP)
