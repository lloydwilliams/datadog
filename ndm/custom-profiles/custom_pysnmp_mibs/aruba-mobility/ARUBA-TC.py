...
# ASN.1 source file:///Users/lloyd.williams/u01/snmp/mibdump/asn1/ARUBA-TC
...
MibIdentifier, ModuleIdentity, Bits, ObjectSyntax, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Unsigned32, iso, IpAddress, Counter32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Bits", "ObjectSyntax", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Unsigned32", "iso", "IpAddress", "Counter32", "ObjectIdentity", "Counter64")
...
class ArubaPortSpeed(TextualConvention, Integer32):
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8))
    namedValues = NamedValues(("speed10Mbps", 1), ("speed100Mbps", 2), ("speed1000Mbps", 3), ("speedAuto", 4), ("speed10Gbps", 5), ("speed2Gbps", 6), ("speed5Gbps", 7), ("speed40Gbps", 8))
...
mibBuilder.exportSymbols("ARUBA-TC", ArubaACLAction=ArubaACLAction, ArubaMonEncryptionCipher=ArubaMonEncryptionCipher, ArubaDot3bzStatus=ArubaDot3bzStatus, ArubaActiveState=ArubaActiveState, ArubaConfigurationChangeType=ArubaConfigurationChangeType, ArubaACLDomain=ArubaACLDomain, ArubaEncryptionMethods=ArubaEncryptionMethods, ArubaPoeState=ArubaPoeState, ArubaDBType=ArubaDBType, ArubaPortType=ArubaPortType, ArubaAPMasterStatus=ArubaAPMasterStatus, ArubaThresholdResourceType=ArubaThresholdResourceType, ArubaIfState=ArubaIfState, ArubaUnprovisionedStatus=ArubaUnprovisionedStatus, ArubaVoipProtocol=ArubaVoipProtocol, ArubaDot1dState=ArubaDot1dState, ArubaFrameType=ArubaFrameType, ArubaEncryptionType=ArubaEncryptionType, ArubaAntennaSetting=ArubaAntennaSetting, ArubaPortDuplex=ArubaPortDuplex, ArubaVoipRegState=ArubaVoipRegState, ArubaSupportStatus=ArubaSupportStatus, ArubaStationType=ArubaStationType, ArubaHTRate=ArubaHTRate, ArubaIfStateChangeReason=ArubaIfStateChangeReason, ArubaACLNetworkServiceType=ArubaACLNetworkServiceType, ArubaAuthenticationMethods=ArubaAuthenticationMethods, ArubaEnet1Mode=ArubaEnet1Mode, ArubaBlackListReason=ArubaBlackListReason, ArubaARMChangeReason=ArubaARMChangeReason, ArubaIfType=ArubaIfType, ArubaVoiceCdrDirection=ArubaVoiceCdrDirection, ArubaCardType=ArubaCardType, ArubaDot3azStatus=ArubaDot3azStatus, ArubaUserForwardMode=ArubaUserForwardMode, ArubaHTExtChannel=ArubaHTExtChannel, ArubaAddressType=ArubaAddressType, ArubaMeshRole=ArubaMeshRole, ArubaStackChangeEvent=ArubaStackChangeEvent, ArubaPortSpeed=ArubaPortSpeed, ArubaVlanValidRange=ArubaVlanValidRange, ArubaVoiceCacBit=ArubaVoiceCacBit, ArubaPortMode=ArubaPortMode, ArubaAPMatchType=ArubaAPMatchType, ArubaAPStatus=ArubaAPStatus, ArubaAPUplinkType=ArubaAPUplinkType, ArubaHaRole=ArubaHaRole, ArubaMonEncryptionType=ArubaMonEncryptionType, ArubaSubAuthenticationMethods=ArubaSubAuthenticationMethods, ArubaVrrpState=ArubaVrrpState, ArubaMonAuthAlgorithm=ArubaMonAuthAlgorithm, ArubaDaysOfWeek=ArubaDaysOfWeek, ArubaAPUplinkChangeReason=ArubaAPUplinkChangeReason, ArubaPhyType=ArubaPhyType, ArubaESIServerMode=ArubaESIServerMode, ArubaHTMode=ArubaHTMode, ArubaAccessPointMode=ArubaAccessPointMode, ArubaOperStateValue=ArubaOperStateValue, ArubaEnableValue=ArubaEnableValue, ArubaSwitchRole=ArubaSwitchRole, ArubaAuthServerType=ArubaAuthServerType, ArubaCallStates=ArubaCallStates, InterfaceIndex=InterfaceIndex, ArubaAPDot1dState=ArubaAPDot1dState, ArubaVoipProtocolType=ArubaVoipProtocolType, ArubaFlexRadioMode=ArubaFlexRadioMode, ArubaRogueApType=ArubaRogueApType, ArubaESIServerStatus=ArubaESIServerStatus, ArubaHaConnectivityStatus=ArubaHaConnectivityStatus, ArubaAPMatchMethod=ArubaAPMatchMethod, ArubaMonitorMode=ArubaMonitorMode, ArubaConfigurationState=ArubaConfigurationState, ArubaStackIfTopoJoined=ArubaStackIfTopoJoined, ArubaPortalServerDownReason=ArubaPortalServerDownReason, ArubaStackState=ArubaStackState, ArubaHashAlgorithms=ArubaHashAlgorithms)
