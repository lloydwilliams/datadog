...
# ASN.1 source file:///Users/lloyd.williams/u01/snmp/github/mibs.snmplabs.com/asn1/IF-MIB
...
Counter32, ObjectIdentity, mib_2, TimeTicks, ModuleIdentity, iso, Bits, Integer32, MibIdentifier, NotificationType, IpAddress, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "mib-2", "TimeTicks", "ModuleIdentity", "iso", "Bits", "Integer32", "MibIdentifier", "NotificationType", "IpAddress", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
AutonomousType, DisplayString, TestAndIncr, TruthValue, TextualConvention, RowStatus, PhysAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TestAndIncr", "TruthValue", "TextualConvention", "RowStatus", "PhysAddress", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifGroups=ifGroups, ifXEntry=ifXEntry, ifXTable=ifXTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackLowerLayer=ifStackLowerLayer, PYSNMP_MODULE_ID=ifMIB, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestGroup=ifTestGroup, ifRcvAddressTable=ifRcvAddressTable, ifTable=ifTable, ifStackLastChange=ifStackLastChange, ifStackTable=ifStackTable, ifConformance=ifConformance, ifTestType=ifTestType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestStatus=ifTestStatus, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliance=ifCompliance, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestResult=ifTestResult, ifOutNUcastPkts=ifOutNUcastPkts, ifCompliances=ifCompliances, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, linkDown=linkDown, ifAdminStatus=ifAdminStatus, ifHighSpeed=ifHighSpeed, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifNumber=ifNumber, ifInUnknownProtos=ifInUnknownProtos, ifHCInUcastPkts=ifHCInUcastPkts, ifSpecific=ifSpecific, ifGeneralGroup=ifGeneralGroup, ifCompliance3=ifCompliance3, ifMIB=ifMIB, ifOperStatus=ifOperStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifType=ifType, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackGroup2=ifStackGroup2, ifInNUcastPkts=ifInNUcastPkts, ifTestTable=ifTestTable, ifTableLastChange=ifTableLastChange, ifHCInOctets=ifHCInOctets, ifStackHigherLayer=ifStackHigherLayer, ifPromiscuousMode=ifPromiscuousMode, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifOutErrors=ifOutErrors, ifStackGroup=ifStackGroup, ifTestId=ifTestId, OwnerString=OwnerString, interfaces=interfaces, ifSpeed=ifSpeed, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliance2=ifCompliance2, ifOutOctets=ifOutOctets, ifMtu=ifMtu, ifTestEntry=ifTestEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCPacketGroup=ifHCPacketGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifOutQLen=ifOutQLen, ifOutUcastPkts=ifOutUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifStackStatus=ifStackStatus, linkUp=linkUp, ifTestCode=ifTestCode, ifAlias=ifAlias, InterfaceIndex=InterfaceIndex, ifInMulticastPkts=ifInMulticastPkts, ifPhysAddress=ifPhysAddress, ifRcvAddressGroup=ifRcvAddressGroup, ifOutDiscards=ifOutDiscards, ifPacketGroup=ifPacketGroup, ifInOctets=ifInOctets, ifMIBObjects=ifMIBObjects, ifName=ifName, ifDescr=ifDescr, ifHCOutOctets=ifHCOutOctets, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifLastChange=ifLastChange, ifInErrors=ifInErrors, ifIndex=ifIndex, ifOutMulticastPkts=ifOutMulticastPkts, ifInUcastPkts=ifInUcastPkts, ifEntry=ifEntry, ifInDiscards=ifInDiscards, ifStackEntry=ifStackEntry, ifTestOwner=ifTestOwner, ifRcvAddressType=ifRcvAddressType, ifConnectorPresent=ifConnectorPresent)
