...
# ASN.1 source file:///Users/lloyd.williams/u01/snmp/github/mibs.snmplabs.com/asn1/SNMPv2-MIB
...
Counter32, ObjectIdentity, mib_2, TimeTicks, ModuleIdentity, Bits, Integer32, MibIdentifier, Gauge32, NotificationType, snmpModules, IpAddress, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "mib-2", "TimeTicks", "ModuleIdentity", "Bits", "Integer32", "MibIdentifier", "Gauge32", "NotificationType", "snmpModules", "IpAddress", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("SNMPv2-MIB", snmpOutSetRequests=snmpOutSetRequests, snmpTrapEnterprise=snmpTrapEnterprise, authenticationFailure=authenticationFailure, snmpMIBObjects=snmpMIBObjects, sysORTable=sysORTable, snmpNotificationGroup=snmpNotificationGroup, snmpOutPkts=snmpOutPkts, sysORIndex=sysORIndex, snmpMIBGroups=snmpMIBGroups, snmpOutGenErrs=snmpOutGenErrs, snmpMIBCompliances=snmpMIBCompliances, sysObjectID=sysObjectID, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpGroup=snmpGroup, snmpInPkts=snmpInPkts, sysDescr=sysDescr, sysName=sysName, snmpSetSerialNo=snmpSetSerialNo, snmpInBadCommunityUses=snmpInBadCommunityUses, sysORLastChange=sysORLastChange, snmpTraps=snmpTraps, snmpInTotalReqVars=snmpInTotalReqVars, snmpSetGroup=snmpSetGroup, sysORUpTime=sysORUpTime, snmpSilentDrops=snmpSilentDrops, system=system, sysContact=sysContact, sysORID=sysORID, snmpInTraps=snmpInTraps, snmpInNoSuchNames=snmpInNoSuchNames, snmpOutTooBigs=snmpOutTooBigs, snmpOutGetResponses=snmpOutGetResponses, snmpSet=snmpSet, snmpInSetRequests=snmpInSetRequests, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, sysOREntry=sysOREntry, warmStart=warmStart, snmp=snmp, snmpInReadOnlys=snmpInReadOnlys, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpOutTraps=snmpOutTraps, snmpInBadCommunityNames=snmpInBadCommunityNames, snmpInASNParseErrs=snmpInASNParseErrs, snmpProxyDrops=snmpProxyDrops, snmpMIBConformance=snmpMIBConformance, snmpInGenErrs=snmpInGenErrs, snmpMIB=snmpMIB, snmpCommunityGroup=snmpCommunityGroup, snmpInBadValues=snmpInBadValues, snmpInTotalSetVars=snmpInTotalSetVars, snmpInGetNexts=snmpInGetNexts, snmpOutBadValues=snmpOutBadValues, snmpInTooBigs=snmpInTooBigs, sysORDescr=sysORDescr, snmpInBadVersions=snmpInBadVersions, snmpOutGetRequests=snmpOutGetRequests, snmpObsoleteGroup=snmpObsoleteGroup, snmpInGetResponses=snmpInGetResponses, snmpEnableAuthenTraps=snmpEnableAuthenTraps, snmpInGetRequests=snmpInGetRequests, snmpTrapOID=snmpTrapOID, snmpBasicComplianceRev2=snmpBasicComplianceRev2, sysServices=sysServices, snmpBasicCompliance=snmpBasicCompliance, sysUpTime=sysUpTime, snmpTrap=snmpTrap, systemGroup=systemGroup, coldStart=coldStart, snmpOutGetNexts=snmpOutGetNexts, sysLocation=sysLocation, PYSNMP_MODULE_ID=snmpMIB)
