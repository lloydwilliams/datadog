...
# ASN.1 source file:///Users/lloyd.williams/u01/snmp/mibdump/asn1/WLSX-CTS-MIB
...
NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, ModuleIdentity, Unsigned32, snmpModules, Counter64, Integer32, Gauge32, iso, IpAddress, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "ModuleIdentity", "Unsigned32", "snmpModules", "Counter64", "Integer32", "Gauge32", "iso", "IpAddress", "ObjectIdentity", "MibIdentifier")
StorageType, PhysAddress, DisplayString, TestAndIncr, TruthValue, TDomain, TimeInterval, MacAddress, TextualConvention, TAddress, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "StorageType", "PhysAddress", "DisplayString", "TestAndIncr", "TruthValue", "TDomain", "TimeInterval", "MacAddress", "TextualConvention", "TAddress", "RowStatus")
...
mibBuilder.exportSymbols("WLSX-CTS-MIB", wlsxCtsURL=wlsxCtsURL, PYSNMP_MODULE_ID=wlsxCtsMIB, wlsxCtsRequestEntry=wlsxCtsRequestEntry, wlsxCtsRequestTable=wlsxCtsRequestTable, wlsxCtsOpcode=wlsxCtsOpcode, wlsxCtsStatus=wlsxCtsStatus, wlsxCtsOpGroup=wlsxCtsOpGroup, wlsxCtsMIB=wlsxCtsMIB, wlsxCtsFlags=wlsxCtsFlags, wlsxCtsCookie=wlsxCtsCookie, wlsxCtsIndex=wlsxCtsIndex)
